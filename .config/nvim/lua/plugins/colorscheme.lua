            ...
            require("github-theme").setup({
                ...
                groups = {
                    github_dark_default = vim.tbl_extend("force", {
                        ...
                        TreesitterContextLineNumber = { fg = "fg2", bg = "NONE" },
                        TreesitterContextBottom = { bg = "NONE", sp = "palette.neutral.muted", style = "underline" },
                        TreesitterContextLineNumberBottom = { fg = "fg2", bg = "NONE", sp = "palette.neutral.muted", style = "underline" },
