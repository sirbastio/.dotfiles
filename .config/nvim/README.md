...
- **LSP Configs:** [nvim-lspconfig](https://github.com/neovim/nvim-lspconfig)
- **Formatting:** [Conform](https://github.com/stevearc/conform.nvim)
- **Completions:** [Blink](https://github.com/saghen/blink.cmp)
- **Syntax Parser & Highlights:** [nvim-treesitter](https://github.com/nvim-treesitter/nvim-treesitter)
...
- **Status Line:** [mini.statusline](https://github.com/nvim-mini/mini.statusline) ~~[lualine](https://github.com/nvim-lualine/lualine.nvim)~~
...
- **Icons:** [Nvim-web-devicons](https://github.com/nvim-tree/nvim-web-devicons) ~~[mini.icons](https://github.com/nvim-mini/mini.icons)~~
...
- **Gui:** [Snacks.Lazygit](https://github.com/folke/snacks.nvim/blob/main/docs/lazygit.md) ~~[Neogit](https://github.com/neogitorg/neogit)~~
